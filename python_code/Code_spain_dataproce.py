...
## -------------------
# data = pd.ExcelFile(filepath + "//Majadas2017-Eddy__Flox_and_refl.xlsx", encoding='utf-8')
# data=data.parse(0)
# # 剔除SIF<0的值
...
#     'rDate_Subcanopy_15','datetime_sd','date_time_radiance'],axis=1)
# # print(data.shape)
# # # 保存剔除的结果
...
# # 求日平均
data=pd.read_csv(r'D:\Thesis2\data_processed\spain\Majadas2017-Eddy_and_Flox_droptime_sifclean_8-18_norain.csv')
DOYnew=data['new_DOY']
all1=[]
daymean=[]
